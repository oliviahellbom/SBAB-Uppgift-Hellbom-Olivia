...
public class HandleFiles {
	...
	//Calls the parsers based on filetype
	...
	//Parses the xml-file and returns a list of objects (products)
	...
	//Parses the json-file and returns a list of objects (products)
	...
	//Parses the csv-file and returns a list of objects (products)
